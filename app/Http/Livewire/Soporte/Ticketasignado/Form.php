...
class Form extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.soporte.ticketasignado.form',compact('idusuario','usuario','correo','tipos','areas','direcciones','tecnicos','categorias','identificadores','prioridades'));
    }
    ...
    public function update(){
        ...
        $detalle->titulo = 'Alerta Administrador - '.$this->Tickets->titulo;
