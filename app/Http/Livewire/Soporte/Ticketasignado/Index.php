...
namespace App\Http\Livewire\Soporte\Ticketasignado;
...
class Index extends Component
{
    ...
    {
        $count = Ticketsupport::where('status','=','A')->where('tecnico_id','>',1)->whereIn('estadoticket_id',[1,2,3,5,6])->count();
        $tickets = Ticketsupport::where('status','=','A')->where('tecnico_id','>',1)->whereIn('estadoticket_id',[1,2,3,5,6])->orderBy('id', 'DESC');
        ...
        return view('livewire.soporte.ticketasignado.index', compact('count', 'tickets'));
    }
