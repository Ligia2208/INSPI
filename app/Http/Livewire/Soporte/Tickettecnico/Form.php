...
class Form extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.soporte.tickettecnico.form',compact('idusuario','usuario','correo','tipos','areas','direcciones','tecnicos','categorias','identificadores','prioridades'));
    }
