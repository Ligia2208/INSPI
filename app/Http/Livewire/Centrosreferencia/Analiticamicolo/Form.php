...
class Form extends Component
{
    ...
    public function mount(Analiticamicolo $Analiticastoxico, $method){
    ...
    public function render()
    {
        ...
        return view('livewire.centrosreferencia.analiticamicolo.form', compact('sedes','muestras','instituciones','paramicrobianos','paradifusion','parabiograma',
    ...
    public function store(){
        ...
        //return redirect()->route('analiticamicolo.index');
    ...
    public function update(){
        ...
        try{
            ...
            if($this->Analiticastoxico->tecnica_segunda_id>0 && $this->Analiticastoxico->adicional==0){
                $newMuestra = new Analiticamicolo();
