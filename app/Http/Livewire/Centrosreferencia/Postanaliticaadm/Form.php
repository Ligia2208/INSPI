...
class Form extends Component
{
    ...
    public function mount(Postanalitica $Analiticas, $method){
        ...
        $res = Analitica::where('preanalitica_id','=',$data->id)->pluck('resultado_id')->first();
    ...
    public function render()
    {
        ...
        return view('livewire.centrosreferencia.postanaliticaadm.form', compact('sedes','muestras'));
    }
