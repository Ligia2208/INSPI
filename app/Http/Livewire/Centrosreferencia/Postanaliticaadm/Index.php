...
namespace App\Http\Livewire\Centrosreferencia\Postanaliticaadm;
...
class Index extends Component
{
    ...
    {
        $iduser = auth()->user()->id;
        $sedes_users = Responsable::where('estado','=','A')->where('tipo_id','=',4)->where('usuario_id','=',$iduser)->where('vigente_hasta','=',null)->distinct('sedes_id')->pluck('sedes_id')->toArray();
        $crns_users = Responsable::where('estado','=','A')->where('tipo_id','=',4)->where('usuario_id','=',$iduser)->where('vigente_hasta','=',null)->distinct('crns_id')->pluck('crns_id')->toArray();
        ...
        $analiticas = Preanalitica::where('validado','=','S')->whereIn('id',$analiticapac);
        ...
        return view('livewire.centrosreferencia.postanaliticaadm.index', compact('count', 'analiticas','sedes','crns','eventos'));
    }
