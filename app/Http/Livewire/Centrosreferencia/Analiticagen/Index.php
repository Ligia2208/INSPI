...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        $analiticastoxico = Analitica::where('estado','=','A')->where('usuarior_id','=',0)->whereIn('sedes_id',$sedes_users)->whereIn('crns_id',$crns_users)->where('resultado_id','=',0)->orderBy('codigo_calidad', 'desc');
