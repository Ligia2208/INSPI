...
class Form extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.centrosreferencia.postanaliticatoxico.form', compact('sedes','muestras','detalles','data','estados','unidades','clases','medicamentopi','medicamentonrti','medicamentonnrti','medicamentoini'));
    }
    ...
    public function store(){
        ...
        return redirect()->route('postanaliticatoxico.index');
