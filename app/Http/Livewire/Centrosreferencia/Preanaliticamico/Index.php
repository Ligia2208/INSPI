...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        if($this->csedes){
            ...
            $count = $preanaliticas->count();
            $config = SedeCrn::where('sedes_id','=',$this->csedes)->where('crns_id','=',1)->orderBy('id', 'asc')->pluck('crns_id')->toArray();
        ...
        return view('livewire.centrosreferencia.preanaliticamico.index', compact('count', 'preanaliticas','sedes','crns','eventos'));
    }
