...
class Form extends Component
{
    ...
    public function render(){
        ...
        return view('livewire.centrosreferencia.analiticacd4.form', compact('sedes','muestras','instituciones','paramicrobianos','paradifusion','parabiograma','bacteantibioticomic','bacteantibioticokb','medicamentopi','medicamentonrti','medicamentonnrti','medicamentoini','preanalitica','estados','unidades','clases'));
    }
