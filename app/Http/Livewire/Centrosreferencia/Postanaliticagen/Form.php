...
namespace App\Http\Livewire\Centrosreferencia\Postanaliticagen;
...
class Form extends Component
{
    ...
    public function render()
    {
        ...
        $detallesUser = Analitica::where('estado','=','A')->where('preanalitica_id','=',$this->Analiticas->id)->first();
        // dd($detalles); edad sexo
        ...
        return view('livewire.centrosreferencia.postanaliticagen.form', compact('sedes','muestras','detalles','data','estados','unidades','clases',
            'medicamentopi','medicamentonrti','medicamentonnrti','medicamentoini','detallesUser'));
    }
