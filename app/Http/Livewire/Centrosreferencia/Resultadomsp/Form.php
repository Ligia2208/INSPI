...
namespace App\Http\Livewire\Centrosreferencia\Resultadomsp;
...
class Form extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.centrosreferencia.resultadomsp.form', compact('sedes','sexos','provincias'));
    }
    ...
    public function store(){
        ...
        return redirect()->route('resultadomsp.index');
