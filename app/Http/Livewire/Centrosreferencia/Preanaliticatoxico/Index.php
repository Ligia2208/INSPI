...
namespace App\Http\Livewire\Centrosreferencia\Preanaliticatoxico;
...
class Index extends Component
{
    ...
    public function render()
    {
        ...
        if($this->csedes){
            ...
            $count = $preanaliticas->count();
            $config = SedeCrn::where('sedes_id','=',$this->csedes)->where('crns_id','=',7)->orderBy('id', 'asc')->pluck('crns_id')->toArray();
        ...
        return view('livewire.centrosreferencia.preanaliticatoxico.index', compact('count', 'preanaliticas','sedes','crns','eventos'));
    }
