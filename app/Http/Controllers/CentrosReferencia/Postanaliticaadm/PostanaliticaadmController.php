...
namespace App\Http\Controllers\CentrosReferencia\Postanaliticaadm;
...
class PostanaliticaadmController extends Controller
{
    public function __construct()
    {
        $this->middleware(['permission:postanaliticasadm']);
    }

    public function index(){
        return view('centrosreferencia.postanaliticaadm.index');
    }

    public function create(){
        $postanalitica = new Postanalitica();
        return view('centrosreferencia.postanaliticaadm.create', compact('postanalitica'));
    }
    ...
    public function show(Preanalitica $postanalitica){
        ...
        return view('centrosreferencia.postanaliticaadm.show', compact('postanalitica','muestras'));
    }

    public function edit(Postanalitica $postanalitica){
        $muestras = Analitica::where('estado','=','A')->where('preanalitica_id','=',$postanalitica->id)->get();
        $pre = Preanalitica::findOrFail($postanalitica->id);
        return view('centrosreferencia.postanaliticaadm.edit', compact('postanalitica','muestras','pre'));
    }

    public function informeadm($id){
