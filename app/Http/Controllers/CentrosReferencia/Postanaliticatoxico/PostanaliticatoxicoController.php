...
namespace App\Http\Controllers\CentrosReferencia\Postanaliticatoxico;
...
class PostanaliticatoxicoController extends Controller
{
    public function __construct()
    {
        $this->middleware(['permission:postanaliticastoxico']);
    }

    public function index(){
        return view('centrosreferencia.postanaliticatoxico.index');
    }

    public function create(){
        $postanalitica = new Postanalitica();
        return view('centrosreferencia.postanaliticatoxico.create', compact('postanalitica'));
    }
    ...
    public function show(Preanalitica $postanalitica){
        ...
        return view('centrosreferencia.postanaliticatoxico.show', compact('postanalitica','muestras'));
    }

    public function edit(Postanalitica $postanalitica){
        $muestras = Analitica::where('estado','=','A')->where('preanalitica_id','=',$postanalitica->id)->get();
        return view('centrosreferencia.postanaliticatoxico.edit', compact('postanalitica','muestras'));
    }
    ...
    public function informep($id){
        ...
        if($data->crns_id==7){
            $this->fpdf->Ln(6.5);
            $this->fpdf->Cell(32,6.5,utf8_decode("Código muestra"),1,0,"C");
            $this->fpdf->Cell(20,6.5,utf8_decode("Tipo muestra"),1,0,"C");
            $this->fpdf->Cell(21,6.5,utf8_decode("Toma muestra"),1,0,"C");
            $this->fpdf->Cell(21,6.5,utf8_decode("Recepción CRN"),1,0,"C");
            $this->fpdf->Cell(23,6.5,utf8_decode("Evento"),1,0,"C");
            $this->fpdf->Cell(41,6.5,utf8_decode("Técnica aplicada"),1,0,"C");
            $this->fpdf->Cell(32,6.5,utf8_decode("Resultado"),1,0,"C");
            $this->fpdf->SetFont('Arial', '', 7);
            $i=0;
            foreach($data_muestras as $muestra){
                $this->fpdf->Ln(6.5);
                $this->fpdf->Cell(32,6.5,utf8_decode($muestra->codigo_calidad),1,0,"C");
                $this->fpdf->Cell(20,6.5,utf8_decode(substr($muestra->muestra->descripcion,0,15)),1,0,"C");
                $this->fpdf->Cell(21,6.5,utf8_decode($muestra->fecha_toma),1,0,"C");
                $this->fpdf->Cell(21,6.5,utf8_decode($muestra->fecha_llegada_lab),1,0,"C");
                $this->fpdf->Cell(23,6.5,utf8_decode($muestra->evento->simplificado),1,0,"C");
                if($muestra->tecnica_id>0){
                    $this->fpdf->Cell(41,6.5,utf8_decode(substr($muestra->tecnica->descripcion,0,34)),1,0,"L");
                    $this->fpdf->Cell(32,6.5,utf8_decode(substr($muestra->resultado->descripcion,0,32)),1,0,"L");
                }
                else{
                    $this->fpdf->Cell(41,6.5,utf8_decode(""),1,0,"C");
                    $this->fpdf->Cell(32,6.5,utf8_decode(""),1,0,"C");
                }
        ...
        if($muestra->crns_id==6){
            ...
            if($muestra->antibiogramamico_id>0){
                    ...
                    if($muestra->fungicounomico_id>0){
                        $this->fpdf->Cell(75,6,utf8_decode($muestra->fungicounomico->descripcion),1,0,"C");
                        ...
                        if($muestra->escalaunomico_id==1){
                            $this->fpdf->Cell(40,6,utf8_decode("Sensible"),1,0,"C");
                        }
                        if($muestra->escalaunomico_id==2){
                            $this->fpdf->Cell(40,6,utf8_decode("Intermedio"),1,0,"C");
                        }
                    ...
                    if($muestra->fungicodosmico_id>0){
                        $this->fpdf->Cell(75,6,utf8_decode($muestra->fungicodosmico->descripcion),1,0,"C");
                    ...
                    if($muestra->fungicotresmico_id>0){
                        $this->fpdf->Cell(75,6,utf8_decode($muestra->fungicotresmico->descripcion),1,0,"C");
                    ...
                    if($muestra->fungicocuatromico_id>0){
                        $this->fpdf->Cell(75,6,utf8_decode($muestra->fungicocuatromico->descripcion),1,0,"C");
                    ...
                    if($muestra->fungicocincomico_id>0){
                        $this->fpdf->Cell(75,6,utf8_decode($muestra->fungicocincomico->descripcion),1,0,"C");
                    ...
                    if($muestra->fungicoseismico_id>0){
                        $this->fpdf->Cell(75,6,utf8_decode($muestra->fungicoseismico->descripcion),1,0,"C");
                    ...
                    if($muestra->fungicosietemico_id>0){
                        $this->fpdf->Cell(75,6,utf8_decode($muestra->fungicosietemico->descripcion),1,0,"C");
