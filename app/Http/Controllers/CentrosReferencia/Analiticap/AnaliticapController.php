...
namespace App\Http\Controllers\CentrosReferencia\Analiticap;
...
class AnaliticapController extends Controller
{
    ...
    public function index(){
        return view('centrosreferencia.analiticap.index');
    }

    public function create(){
        $analitica = new Analitica();
        return view('centrosreferencia.analiticap.create', compact('analitica'));
    }

    public function show(Analitica $analitica){
        return view('centrosreferencia.analiticap.show', compact('analitica'));
    }

    public function edit(Analitica $analitica){
        return view('centrosreferencia.analiticap.edit', compact('analitica'));
    }
