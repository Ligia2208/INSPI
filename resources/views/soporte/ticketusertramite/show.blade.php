...
@section('title', str_pad($ticketusertramite->id, 5, "0", STR_PAD_LEFT))
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline mr-5">
                    <a class="text-dark" href="{{ route('ticketusertramite.index') }}">
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header h-auto py-4">
                                <div class="card-title">
                                    <h3 class="card-label">Ticket No. {{ str_pad($ticketusertramite->id, 5, "0", STR_PAD_LEFT) }} - {{ $ticketusertramite->titulo }}</h3>
                                </div>
                                <div class="d-flex justify-content-end">
                                    <i class="navi-item" data-toggle="modal" data-target="_self">
                                        <a href="{{ route('ticketusertramite.index') }}" class="navi-link">
