...
@section('title', str_pad($ticketseguimiento->id, 5, '0', STR_PAD_LEFT))
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline mr-5">
                    <a class="text-dark" href="{{ route('ticketseguimiento.index') }}">
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header h-auto py-4">
                                <div class="card-title">
                                    <h3 class="card-label">Ticket No.
                                        {{ str_pad($ticketseguimiento->id, 5, '0', STR_PAD_LEFT) }} -
                                        {{ $ticketseguimiento->titulo }}</h3>
                                </div>
                                <div class="d-flex justify-content-end">
                                    <i class="navi-item" data-toggle="modal" data-target="_self">
                                        <a href="{{ route('ticketseguimiento.index') }}" class="navi-link">
                                    ...
                                    <i class="navi-item" data-toggle="modal" data-target="_self">
                                        <a href="" class="navi-link">
                                            <span class="navi-icon">
                                                <i class="ace-icon fa fa-pen icon-xl" style="color:lightblue"
                                                    title="Editar"></i>
                                            </span>
                                        </a>
                                    </i>
                                            ...
                                            <li class="timeline-item mb-5">
                                                <span class="timeline-icon">
                                                    @if ($objDet->funcion == 'Usuario')
                                                        ...
                                                        <label
                                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $objDet->funcion }}</label>
                                                    @endif
                                                ...
                                                <hr>
                                                <h5 class="fw-bold">{{ $objDet->titulo }} - {{ $objDet->usuario->name }}
                                                    @if ($objDet->archivo != null)
                                                        - (Ver adjuntos <i class="ace-icon fa fa-eye"
                                                            style="color:rgb(250, 0, 0)"
                                                            onclick="veroficio('{{ $objDet->archivo }}')"
                                                            title="Archivos adjuntos"></i>)
                                                    @endif
                                                </h5>
                                                <p class="text-muted mb-2 fw-bold">{{ $objDet->fecha_registro }}</p>
                                                <p class="text-muted">
                                                    <span
                                                        class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $objDet->descripcion }}</span>
