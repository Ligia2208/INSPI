            ...
            <div class="card-body pt-0 pb-3">
                ...
                <div class="table-responsive">
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @forelse ($Revisiones as $objRevi)
                                @if ($objRevi->cerrado==1)
                                    <tr style="background-color:#FDEDEC">
                                @else
                                    <tr >
                                @endif
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objRevi->nombreactividad }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-25 font-weight-bolder d-block font-size-lg">{{ $objRevi->fechaevento }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-25 font-weight-bolder d-block font-size-lg">{{ $objRevi->resumen }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-25 font-weight-bolder d-block font-size-lg">{{ $objRevi->area->nombre }}</span>
                                    </td>
                                    <td align="center">
                                        <i class="navi-item" data-toggle="modal" data-target="#edit-{{ $objRevi->id }}">
                                        ...
                                        <i class="navi-item" data-toggle="modal" data-target="_self">
                                            <a href="{{ route('revision.show', $objRevi->id) }}" class="navi-link">
                                                <span class="navi-icon">
                                ...
                                @include('intranet.revision.edit')
                            @empty 
                                <!--begin::Col-->
                                <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <br> Ponga en marcha SoftInspi añadiendo su primer Área/Dirección</p>
                    <a data-toggle="modal" data-target=".create" href="#" class="btn btn-primary">Agregar Área/Dirección</a>
                </div>
