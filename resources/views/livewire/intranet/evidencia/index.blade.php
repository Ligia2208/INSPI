        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header" wire:ignore>
                ...
                <div class="card-toolbar">
                    ...
                    &nbsp;&nbsp;
                    <a href="/evidencia/agregar/{{ $id) }}" class="btn btn-primary">Nuevo</a>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <a href="/evidencia/agregar/{{ $id }}"  class="btn btn-primary">Agregar Evidencia</a>
                </div>
    ...
    @push('footer')
        <script>
            function confirmDestroyQuotation(id){
                swal.fire({
                    title: "¿Estas seguro?",
                    text: "No podrás recuperar esta evidencia",
                    icon: "warning",
