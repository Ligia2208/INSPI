                    ...
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @forelse ($Tickets as $objTicket)
                                <tr>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objTicket->id }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objTicket->titulo }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-55 font-weight-bolder d-block font-size-lg">{{ $objTicket->descripcion }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-25 font-weight-bolder d-block font-size-lg">{{ $objTicket->usuario }}</span>
                                    </td>
                                    <td align="center">
                                        <i class="navi-item" data-toggle="modal" data-target="#edit-{{ $objTicket->id }}">
                                        ...
                                        <i class="navi-item" onclick="event.preventDefault(); confirmDestroy({{ $objTicket->id }})">
                                            <a href="#" class="navi-link">
                                            <span class="navi-icon">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <p class="text-gray-400 fs-4 fw-bold mb-10">Al parecer no tienes ningun ticket pendiente de asignar.
                    <br>Pronto CoreInspi te informará de algún pedido de soporte. </p>
                </div>
