                    ...
                    <div class="card card-custom gutter-b card-stretch">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column align-items-center">
                                <!--begin: Icon-->
                                <div>
                                    <p class="text-dark-75 font-weight-bold my-4 font-size-lg">Fecha firma: {{ $objCon->total }}</p>
                                </div>                                
                                <a class="text-dark-75 font-weight-bold mt-1 font-size-lg">Estado: {{ $objCon->tipo}}</a>
                                <!--end: Tite-->
                            </div>
