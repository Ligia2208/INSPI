<div class="col-xl-12">
            ...
            <div class="card-body pt-0 pb-3">
                ...
                <div class="table-responsive">
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @forelse ($Personas as $objPer)
                                <tr>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objPer->identidad }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objPer->apellidos }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objPer->nombres }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-25 font-weight-bolder d-block font-size-lg">{{ $objPer->fechanacimiento }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-25 font-weight-bolder d-block font-size-lg">{{ $objPer->direccion }}</span>
                                    </td>
                                    <td align="center">
                                        <i class="navi-item" data-toggle="modal" data-target="#edit-{{ $objPer->id }}">
                                        ...
                                        <i class="navi-item" onclick="event.preventDefault(); confirmDestroy({{ $objPer->id }})">
                                            <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                        ...
                                        @if ($objPer->archivo != null)
                                        <i class="navi-item" data-toggle="modal" data-target="#">
                                            <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                                <i class="ace-icon fa fa-file-pdf" style="color:gray" onclick="veroficio('{{$objPer->archivo}}')" title="Descargar CV"></i>
                                            </span>
                                            </a>
                                        </i>
                                        @else
                                        <i class="navi-item" data-toggle="modal" data-target="#">
                                            <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                                <i class="ace-icon fa fa-ban" style="color:gray" title="Sin CV"></i>
                                            </span>
                                            </a>
                                        </i>
                                        @endif
                                ...
                                @include('recursoshumanos.persona.edit')
                            @empty
                                <!--begin::Col-->
                                <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <p class="text-gray-400 fs-4 fw-bold mb-10">Al parecer no tienes ninguna Persona.
                    <br> Ponga en marcha CoreInspi añadiendo su primera Persona</p>
    ...
    @include('recursoshumanos.persona.create')
    ...
    @section('footer')
        ...
        <script>
            ...
            function confirmDestroy(id){
                swal.fire({
                    title: "¿Estas seguro?",
                    text: "No podrá recuperar esta Persona y los servicios creados con este tipo se quedarán sin vinculación",
                    icon: "warning",
