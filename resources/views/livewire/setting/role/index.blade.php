        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                ...
                <div class="card-toolbar">
                    <a href="#" wire:click.prevent="$emit('createFormRole')" class="btn btn-primary btn-shadow font-weight-bold mr-2 "><i class="fa fa-sticky-note"></i> Agregar</a>
                </div>
            </div>
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-header border-0 align-items-center">
                            ...
                            <div class="d-flex justify-content-end">
                                <i class="navi-item" wire:click.prevent="$emit('showRole', {{ $role->id }})">
                                    <a href="#" class="navi-link">
                                    <span class="navi-icon">
                                        <i class="ace-icon fa fa-eye" style="color:lightgreen" title={{ __("Show") }}></i>
                                    </span>
                                    </a>
                                </i>
                                &nbsp;
                                <i class="navi-item" wire:click.prevent="$emit('editFormRole', {{ $role->id }})">
                                    <a href="#" class="navi-link">
                                    <span class="navi-icon">
                                        <i class="ace-icon fa fa-pen" style="color:lightblue" title={{ __("Edit") }}></i>
                                    </span>
                                    </a>
                                </i>
                                &nbsp;
                                <i class="navi-item" onclick="event.preventDefault(); confirmDestroy({{ $role->id }})">
                                    <a href="#" class="navi-link">
                                    <span class="navi-icon">
                                        <i class="ace-icon fa fa-trash-alt" style="color:red" title={{ __("Delete") }}></i>
                                    </span>
                                    </a>
                                </i>
                            </div>
