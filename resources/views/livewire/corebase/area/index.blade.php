            ...
            <div class="card-body pt-0 pb-3">
                ...
                <div class="table-responsive">
                        <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                            ...
                            <tbody>
                                @forelse ($areas as $objArea)
                                    <tr>
                                        <td>
                                            <span
                                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objArea->nombre }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $objArea->descripcion }}</span>
                                        </td>
                                        <td align="center">
                                            <i class="navi-item" data-toggle="modal"
                                                data-target="#edit-{{ $objArea->id }}">
                                            ...
                                            <i class="navi-item"
                                                onclick="event.preventDefault(); confirmDestroy({{ $objArea->id }})">
                                                <a href="#" class="navi-link">
                                                    <span class="navi-icon">
