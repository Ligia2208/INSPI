<div class="col-xl-12">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12 col-xl-12">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 my-2 my-md-0">
                                        <div class="input-icon">
                                            <input wire:model="searcha" type="searcha" class="form-control"
                                                placeholder="Areas...">
                                            <span>
                                                <i class="flaticon2-search-1 text-muted"></i>
                                            </span>
            ...
            <div class="card-body pt-0 pb-3">
                ...
                <div class="table-responsive">
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @forelse ($direcciones as $objDir)
                                <tr>
                                    <td>
                                        <span
                                            class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objDir->nombre }}</span>
                                    </td>
                                    <td>
                                        <span
                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $objDir->descripcion }}</span>
                                    </td>
                                    <td>
                                        <span
                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $objDir->area->nombre }}</span>
                                    </td>
                                    <td align="center">
                                        <i class="navi-item" data-toggle="modal"
                                            data-target="#edit-{{ $objDir->id }}">
                                        ...
                                        <i class="navi-item"
                                            onclick="event.preventDefault(); confirmDestroy({{ $objDir->id }})">
                                            <a href="#" class="navi-link">
                                                <span class="navi-icon">
                                ...
                                @include('corebase.direccion.edit')
                            @empty
                                <!--begin::Col-->
                                <div class="col-12">
                                    <div class="alert alert-custom alert-notice alert-light-dark fade show mb-5"
                                        ...
                                        <div class="alert-text">Sin resultados "{{ $searcha }}"</div>
                                    </div>
                                </div>
                            @endforelse
                        </tbody>
            ...
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <p class="text-gray-400 fs-4 fw-bold mb-10">Al parecer no tienes ninguna Dirección Técnica.
                        <br> Ponga en marcha SoftInspi añadiendo su primera Dirección Técnica
                    </p>
    ...
    @include('corebase.direccion.create')
