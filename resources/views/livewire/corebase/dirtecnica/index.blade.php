<div class="col-xl-12">
                                    ...
                                    <div class="col-md-4 my-2 my-md-0">
                                        <div class="input-icon">
                                            <input wire:model="searcht" type="searcht" class="form-control"
                                                placeholder="Gestion/Plataforma/CRN...">
                                            <span>
                        ...
                        <tbody>
                            @forelse ($direcciones as $objDir)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $objDir->direccion->nombre }}</span>
                                    </td>
                                    <td align="center">
                                ...
                                @include('corebase.dirtecnica.edit')
                            @empty
                                <!--begin::Col-->
                                <div class="col-12">
    ...
    @include('corebase.dirtecnica.create')
