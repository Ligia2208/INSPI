                        ...
                        <div class="my-5">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputCodigo">Dirección Técnica/Plataforma/CRN <span class="text-danger">*</label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="input-group input-group-solid">
                                        ...
                                        <input
                                            wire:model.defer="Direcciones.nombre"
                                            type="text"
                                            required
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="input-group input-group-solid">
                                        ...
                                        <input
                                            wire:model.defer="Direcciones.descripcion"
                                            type="text"
                                            required
