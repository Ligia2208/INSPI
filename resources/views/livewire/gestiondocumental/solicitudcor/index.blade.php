<div class="container" >
    @if ($count)
        ...
        <div class="row">
            @forelse ($Solicitudescor as $solicitudcor)
                <!--begin::Col-->
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <!--begin::Card-->
                    @if ($solicitudcor->procesado==0)
                        ...
                        <div class="card-header border-0">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    &nbsp
                                    <i class="navi-item" data-toggle="modal" data-target="_self">
                                        <a href="{{ route('solicitudcor.show', $solicitudcor) }}" class="navi-link">
                                            <span class="navi-icon">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <div>
                                    ...
                                    {{ $solicitudcor->fechaasignacionde }}
                                </div>
                                <a href="{{ route('solicitudcor.show', $solicitudcor) }}">
                                    <div>
                                        <!--begin: Tite-->
                                        <p></p>
                                        <p>{{ $solicitudcor->numerodocumento }} ({{ $solicitudcor->solicitud->fechadocumento }})</p>                                        
                                        <p>{{ $solicitudcor->solicitud->descripcion }}</p>
                                    </div>  
                                </a>
                                <p class="text-dark-75 font-weight-bold my-4 font-size-lg">{{ $solicitudcor->area->nombre }}</p>
                                <a class="text-dark-75 font-weight-bold mt-1 font-size-lg">{{ $solicitudcor->solicitud->sumillado }}</a>
                                </center>
                                <!--end: Tite-->
                            </div>
