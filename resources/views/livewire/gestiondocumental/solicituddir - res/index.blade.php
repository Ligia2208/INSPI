<div class="container" >
    @if ($count)
        ...
        <div class="row">
            @forelse ($Solicitudesdir as $solicituddir)
                <!--begin::Col-->
                                ...
                                <div class="d-flex justify-content-end">
                                    <div class="dropdown dropdown-inline" data-toggle="tooltip"  data-placement="left">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                            <a class="dropdown-item" href="{{ route('solicituddir.show', $solicituddir) }}"><i class="fa fa-eye mr-2"></i> Ver</a>
                                            @if ($solicituddir->procesado==0)
                                                <a class="dropdown-item" href="{{ route('solicituddir.edit', $solicituddir) }}"><i class="fa fa-pen mr-2"></i> Editar</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <div>
                                    ...
                                    {{ $solicituddir->fechaasignacionde }}
                                </div>
                                <a href="{{ route('solicituddir.show', $solicituddir) }}">
                                    <div>
                                        <img alt="{{ $solicituddir->numerodocumento }}" class="max-h-65px" src="{{ asset('assets') }}/media/svg/files/pdf.svg"/>
                                        <!--begin: Tite-->
                                        <p></p>
                                        <p>{{ $solicituddir->numerodocumento }} ({{ $solicituddir->solicitud->fechadocumento }})</p>                                        
                                        <p>{{ $solicituddir->solicitud->descripcion }}</p>
                                    </div>  
                                </a>
                                <p class="text-dark-75 font-weight-bold my-4 font-size-lg">{{ $solicituddir->solicitud->dependencia->nombre }}</p>
                                <a class="text-dark-75 font-weight-bold mt-1 font-size-lg">{{ $solicituddir->solicitud->sumillado }}</a>
                                </center>
                                <!--end: Tite-->
                            </div>
