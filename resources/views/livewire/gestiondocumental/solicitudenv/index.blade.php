    ...
    @if ($count)
        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                ...
                <a href="{{ route('solicitudenv.create') }}" class="btn btn-primary btn-shadow font-weight-bold mr-2 "><i class="fa fa-plus"></i> Nuevo</a>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
                        ...
                        <tbody>
                            @forelse ($Solicitudesenv as $solicitudenv)
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $solicitudenv->referencia }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-25 font-weight-bolder d-block font-size-lg">{{ $solicitudenv->fechadocumento }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-25 font-weight-bolder d-block font-size-lg">{{ $solicitudenv->descripcion }}</span>
                                    </td>
                                    <td align="center">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <p class="text-gray-400 fs-4 fw-bold mb-10">Al parecer no tienes ningún Documento registrado.
                    <br> Ponga en marcha CoreInspi añadiendo un Registro de Documentos</p>
                    <a href="{{ route('solicitudenv.create') }}" class="btn btn-primary btn-shadow font-weight-bold mr-2 "><i class="fa fa-plus"></i> Agregar Registro</a>
                </div>
