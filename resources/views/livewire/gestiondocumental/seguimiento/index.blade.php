            ...
            <div class="card-body pt-0 pb-3">
                ...
                <div class="table-responsive">
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @forelse ($Seguimientos as $objSeguir)
                                <?php
                                ...
                                @endif
                                    ...
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objSeguir->estado->nombre }}</span>
                                    </td>
                                    <td align="center">
                                        @if($atraso < 1)
                                    ...
                                    <td align="center">
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objSeguir->alertas }}</span>
                                    </td>
                                    <td align="center">
                                        <i class="navi-item" data-toggle="modal" data-target="_self">
                                            <a href="{{ route('seguimiento.show', $objSeguir) }}" class="navi-link">
                                                <span class="navi-icon">
                                                <i class="ace-icon fa fa-eye" style="color:lightgreen" title="Mostrar"></i>
                                                </span>
                                            </a>
                                        </i>
                                        <i class="navi-item" onclick="event.preventDefault(); confirmDestroy({{ $objSeguir->id }})">
                                            <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                            <i class="ace-icon fa fa-envelope" style="color:lightblue" title="Enviar Notificación"></i>
                                            </span>
                                        </a>
                                    </i>
                                    </td>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <p class="text-gray-400 fs-4 fw-bold mb-10">Al parecer no tienes ningún elemento en tu bandeja.
                    <br> Ponga en marcha CoreInspi añadiendo su primera Solicitud</p>
                    <a data-toggle="modal" data-target=".create" href="#" class="btn btn-primary">Agregar Solicitud</a>
                </div>
    ...
    @section('footer')
        <script>
            ...
            function confirmDestroy(id){
                swal.fire({
                    title: "¿Estas seguro?",
                    text: "Se enviará un correo de notificación. No podrá recuperar la notificación enviada",
                    icon: "warning",
                    buttonsStyling: false,
                    showCancelButton: true,
                    confirmButtonText: "<i class='fa fa-trash'></i> <span class='text-white'>Si, enviar</span>",
