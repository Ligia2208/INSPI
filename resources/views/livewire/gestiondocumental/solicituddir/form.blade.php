        ...
        <div class="card-header" wire:ignore>
            ...
            <div class="card-toolbar">
                <i class="navi-item" data-toggle="modal" data-target="_self">
                    <a href="{{ route('solicituddir.index') }}" class="navi-link">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-10">
                        <div class="my-5">
                            ...
                            <div class="form-group row">
                                <label class="col-3">Descripción de actividades realizadas <span class="text-danger">*</span></label>
                                <div class="col-9">
                                    <div class="input-group input-group-solid">
                                        <textarea 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <div>
                                        <select 
                                            wire:model.defer="Solicitudesdir.estado_id" 
                                            class="form-control selectpicker form-control-solid @error('Solicitudesdir.estado_id') is-invalid @enderror" 
                                            data-size="7"
                                            data-live-search="true"
                                            data-show-subtext="true"
                                            required>
                                    ...
                                    <span class="form-text text-muted"></span>
                                    @error('Solicitudesdir.estado_id') <div><span class="text-danger">{{ $message }}</span></div> @enderror
                                </div>
                            </div>
                        </div>
                    </div>
