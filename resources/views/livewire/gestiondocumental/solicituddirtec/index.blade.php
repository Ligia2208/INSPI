<div class="container" >
    @if ($count)
        ...
        <div class="row">
            @forelse ($Solicitudesdirtec as $solicituddirtec)
                <!--begin::Col-->
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <!--begin::Card-->
                    @if ($solicituddirtec->procesado==0)
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end">
                                    <i class="navi-item" data-toggle="modal" data-target="_self">
                                        <a href="{{ route('solicituddirtec.edit', $solicituddirtec) }}" class="navi-link">
                                    ...
                                    &nbsp
                                    <i class="navi-item" data-toggle="modal" data-target="_self">
                                        <a href="{{ route('solicituddirtec.show', $solicituddirtec) }}" class="navi-link">
                                            <span class="navi-icon">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <div>
                                    ...
                                    {{ $solicituddirtec->fechaasignacionde }}
                                </div>
                                <a href="{{ route('solicituddirtec.show', $solicituddirtec) }}">
                                    <div>
                                        <!--begin: Tite-->
                                        <p></p>
                                        <p>{{ $solicituddirtec->numerodocumento }} ({{ $solicituddirtec->solicitud->fechadocumento }})</p>                                        
                                        <p>{{ $solicituddirtec->solicitud->descripcion }}</p>
                                    </div>  
                                </a>
                                <p class="text-dark-75 font-weight-bold my-4 font-size-lg">{{ $solicituddirtec->area->nombre }}</p>
                                <a class="text-dark-75 font-weight-bold mt-1 font-size-lg">{{ $solicituddirtec->solicitud->sumillado }}</a>
                                </center>
                                <!--end: Tite-->
                            </div>
