        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('user.create') }}" class="btn btn-primary btn-shadow font-weight-bold mr-2 "><i class="fa fa-sticky-note"></i> Agregar</a>
                </div>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @forelse ($user->roles as $role)
                                            <span class="font-weight-bolder font-size-lg ">{{ $role->name }}</span>
                                        @empty
                                    ...
                                    <td>
                                        @forelse ($user->getDirectPermissions() as $permission)
                                            <span class="font-weight-bolder font-size-lg ">{{$permission->name}}</span>
                                        @empty
                                            <span class="font-size-lg badge badge-secondary">Ninguno</span>
                                        @endforelse
                                    </td>
                                        ...
                                        <i class="navi-item">
                                            <a href="{{ route('user.show', $user) }}" class="navi-link">
                                                <span class="navi-icon">
                                                    <i class="fa fa-eye" style="color:lightgreen" alt="Ver"></i>
                                                </span>
                                            </a>
                                        </i>
                                        <i class="navi-item">
                                            <a href="{{ route('user.edit', $user) }}" class="navi-link">
                                                <span class="navi-icon">
                                                    <i class="fa fa-pen" style="color:lightblue" alt="Editar"></i>
                                                </span>
                                            </a>
                                        </i>
                                        <i class="navi-item" onclick="event.preventDefault(); confirmDestroy({{ $user->id }})">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <br> Ponga en marcha CoreINSPI añadiendo su primer usuario</p>
    ...
    @section('footer')
        <script>
            ...
            function confirmDestroy(id){
                swal.fire({
                    title: "¿Estas seguro?",
                    text: "No podrá recuperar este usuario y cualquier información relacionada con este usuario será eliminada",
                    icon: "warning",
