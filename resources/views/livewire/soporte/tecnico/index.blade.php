<div class="col-xl-12">
            ...
            <div class="card-body pt-0 pb-3">
                ...
                <div class="table-responsive">
                        <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                            ...
                            <tbody>
                                @forelse ($tecnicos as $objTec)
                                    <tr>
                                        <td>
                                            <span
                                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objTec->nombre }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $objTec->descripcion_actividades }}</span>
                                        </td>
                                        <td align="center">
                                            <i class="navi-item" data-toggle="modal"
                                                data-target="#edit-{{ $objTec->id }}">
                                            ...
                                            <i class="navi-item"
                                                onclick="event.preventDefault(); confirmDestroy({{ $objTec->id }})">
                                                <a href="#" class="navi-link">
                                                    <span class="navi-icon">
    ...
    @include('soporte.tecnico.create')
