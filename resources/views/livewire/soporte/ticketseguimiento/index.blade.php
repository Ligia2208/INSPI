<div class="col-xl-12">
                        ...
                        <tbody>
                            @forelse ($tickets as $objTicket)
                                <tr>
                                    ...
                                    <td align="center">
                                        @if($objTicket->tipo_id==1)
                                            <span class="badge badge-pill badge-secondary">{{  $objTicket->tipo->nombre }}</span>
                                        @endif
                                        @if($objTicket->tipo_id==2)
                                            <span class="badge badge-pill badge-warning">{{  $objTicket->tipo->nombre }}</span>
                                        @endif
                                        @if($objTicket->tipo_id==3)
                                            <span class="badge badge-pill badge-success">{{  $objTicket->tipo->nombre }}</span>
                                        @endif
                                        @if($objTicket->tipo_id==4)
                                            <span class="badge badge-pill badge-danger">{{  $objTicket->tipo->nombre }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        <span
                                    ...
                                    <td>
                                        <span
                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $objTicket->area->nombre }}</span>
                                    </td>
                                    <td>
                                        <span
                                    ...
                                    <td align="center">
                                        @if($objTicket->estadoticket_id==2)
                                            <span class="badge badge-pill badge-secondary">{{  $objTicket->estadoticket->titulo }}</span>
                                        @endif
                                        @if($objTicket->estadoticket_id==3)
                                            <span class="badge badge-pill badge-warning">{{  $objTicket->estadoticket->titulo }}</span>
                                        @endif
                                        @if($objTicket->estadoticket_id==4)
                                            <span class="badge badge-pill badge-success">{{  $objTicket->estadoticket->titulo }}</span>
                                        @endif
                                        @if($objTicket->estadoticket_id==5)
                                            <span class="badge badge-pill badge-danger">{{  $objTicket->estadoticket->titulo }}</span>
                                        @endif
                                        @if($objTicket->estadoticket_id==7)
                                            <span class="badge badge-pill badge-danger">{{  $objTicket->estadoticket->titulo }}</span>
                                        @endif
                                    </td>
                                    <td align="center">
                                        <i class="navi-item" data-toggle="modal" data-target="_self">
                                            <a href="{{ route('ticketseguimiento.show', $objTicket) }}" class="navi-link">
                                                <span class="navi-icon">
                                                <i class="ace-icon fa fa-binoculars" style="color:rgb(70, 190, 230)"
                                ...
                                @include('soporte.ticketsupport.edit')
                            @empty
                                <!--begin::Col-->
                                <div class="col-12">
    ...
    @include('soporte.ticketsupport.create')
