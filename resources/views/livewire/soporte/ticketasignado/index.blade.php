                                        ...
                                        <i class="navi-item" data-toggle="modal"
                                            ...
                                            <a href="#" class="navi-link">
                                                <span class="navi-icon">
                                                    <i class="ace-icon fa fa-bars" style="color:rgb(70, 190, 230)"
                                                        title="Registrar gestión"></i>
                                                </span>
                                            </a>
                                        </i>
                                        <i class="navi-item"
                                            ...
                                            <a href="#" class="navi-link">
                                                <span class="navi-icon">
                                                    <i class="ace-icon fa fa-lock" style="color:red"
                                                        title="Cerrar Ticket"></i>
                                                </span>
                                            </a>
                                        </i>
                                    </td>
                                </tr>
                                @include('soporte.ticketasignado.edit')
                            @empty
                                <!--begin::Col-->
                                <div class="col-12">
    ...
    @section('footer')
        <script>
            ...
            function confirmDestroy(id) {
                swal.fire({
                    title: "¿Estas seguro?",
                    text: "El ticket será cerrado por intervención del administrador",
                    icon: "warning",
                    buttonsStyling: false,
                    showCancelButton: true,
                    confirmButtonText: "<i class='fa fa-trash'></i> <span class='text-white'>Si, cerrar</span>",
