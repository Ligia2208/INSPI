<div class="col-xl-12">
                    ...
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @forelse ($tickets as $objTicket)
                                <tr>
                                    ...
                                    <td align="center">
                                        <i class="navi-item" data-toggle="modal" data-target="_self">
                                            <i class="navi-item" data-toggle="modal" data-target="_self">
                                                <a href="{{ route('ticketusertramite.show', $objTicket) }}" class="navi-link">
                                                    <span class="navi-icon">
                                                    <i class="ace-icon fa fa-eye" style="color:rgb(70, 190, 230)"
                                        ...
                                        <i class="navi-item" data-toggle="modal"
                                            ...
                                            <a href="#" class="navi-link">
                                                <span class="navi-icon">
                                                    <i class="ace-icon fa fa-cog" style="color:rgb(214, 124, 72)"
                                                        title="Procesar"></i>
                                                </span>
                                            </a>
                                        </i>
                                ...
                                @include('soporte.ticketusertramite.edit')
                            @empty
                                <!--begin::Col-->
                                <div class="col-12">
    ...
    @include('soporte.ticketusertramite.create')
