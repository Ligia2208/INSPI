                                        ...
                                        <i class="navi-item"
                                            ...
                                            <a href="#" class="navi-link">
                                                <span class="navi-icon">
                                                    <i class="ace-icon fa fa-check" style="color:rgb(70, 190, 230)"
                                                        title="Reabrir"></i>
                                                </span>
                                            </a>
                                        </i>
    ...
    @section('footer')
        <script>
            ...
            function confirmDestroy(id) {
                swal.fire({
                    title: "¿Estas seguro?",
                    text: "Se reabrirá el ticket y todo el recorrido existente relacionado con el ticket",
                    icon: "info",
                    buttonsStyling: false,
                    showCancelButton: true,
                    confirmButtonText: "<i class='fa fa-trash'></i> <span class='text-white'>Si, reabrir</span>",
