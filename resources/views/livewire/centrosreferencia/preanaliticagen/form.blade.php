        ...
        <div class="card-body">
            ...
            <form class="form" wire:submit.prevent="{{ $method }}">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="my-5">
                            <a href="{{ route('preanaliticagen.index') }}"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group input-group-solid">
                                        ...
                                        <input wire:model.defer="Preanaliticastoxico.nom_solicita" type="text" required
                                            class="form-control form-control-solid @error('Preanaliticastoxico.nom_solicita') is-invalid @enderror"
                                            placeholder="Ej: Dr. Julio Robles" />
                                    </div>
                                    @error('Preanaliticastoxico.nom_solicita')
                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group input-group-solid">
                                        ...
                                        <input wire:model.defer="Preanaliticastoxico.correo" type="text"
                                            required
                                            class="form-control form-control-solid @error('Preanaliticastoxico.correo') is-invalid @enderror"
                                            placeholder="Ej: Sur de la ciudad" />
                                    </div>
                                    @error('Preanaliticastoxico.correo')
                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group input-group-solid">
                                        ...
                                        <input wire:model.defer="Preanaliticastoxico.edad" type="text"
                                            class="form-control form-control-solid @error('Preanaliticastoxico.edad') is-invalid @enderror"
                                            placeholder="Ej: Cod. de Muestra Hospitalaria" />
                                    </div>
                                    @error('Preanaliticastoxico.edad')
                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                                </div>
