        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                ...
                <button class="btn btn-success font-weight-bold mr-2"
                                onclick="exportToExcel('data', 'analiticastoxico-data')"><i
            ...
            <div class="card-body pt-0 pb-3">
                ...
                <div class="table-responsive">
                    <table id="data"
                        ...
                        <tbody>
                            @forelse ($analiticastoxico as $analiticatoxico)
                                <tr>
                                    <td>
                                        <span
                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $analiticatoxico->codigo_calidad }}</span>
                                    </td>
                                    <td>
                                        <span
                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $analiticatoxico->preanalitica->fecha_recepcion }}</span>
                                    </td>
                                    <td>
                                        <span
                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $analiticatoxico->crns->descripcion }}</span>
                                    </td>
                                    <td>
                                        <span
                                    ...
                                    <td>
                                        @if ($analiticatoxico->tecnica_id > 0)
                                            <span
                                                class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $analiticatoxico->tecnica->descripcion }}</span>
                                        @else
                                        @endif
                                    </td>
                                    <td>
                                        @if ($analiticatoxico->resultado_id > 0)
                                            <span
                                                class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $analiticatoxico->resultado->descripcion }}</span>
                                        @else
                                        @endif
                                    </td>
                                    <td>
                                        <span
                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $analiticatoxico->fecha_resultado }}</span>
                                    </td>
                                    <td>
                                        @if ($analiticatoxico->usuarior_id > 0)
                                            <span
                                                class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $analiticatoxico->usuarior->name }}</span>
                                        @else
                                        @endif
                                    </td>
                                    <td align="center">
                                        ...
                                        <i class="navi-item" data-toggle="modal" data-target="#">
                                            <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                                <i class="ace-icon fa fa-file-pdf" style="color:rgb(238, 51, 51)" onclick="veroficio('{{$analiticatoxico->archivo}}')" title="Descargar Informe"></i>
                                            </span>
                                            </a>
                                        </i>
                                        @else
