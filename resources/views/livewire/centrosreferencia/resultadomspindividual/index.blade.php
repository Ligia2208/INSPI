                            ...
                            <div class="col-lg-12 col-xl-12">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-5 my-2 my-md-0">
                                        <div class="input-icon">
                                            <input wire:model="searchna" type="search" class="form-control"
                                                placeholder="Apellidos y/o Nombres...">
                                            <span>
                                                <i class="flaticon2-search-1 text-muted"></i>
                                            </span>
                                        </div>
                        ...
                        <tbody>
                            @forelse ($resultados as $resultado)
                                <tr>
                                    <td>
                                        <span
                                            class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $resultado->codigo }}</span>
                                    </td>
                                    <td>
                                        <span
                                            class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $resultado->identidad }}</span>
                                    </td>
                                    <td>
                                        <span
                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $resultado->apellidos }} {{ $resultado->nombres }}</span>
                                    </td>
                                    <td>
                                        <span
                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $resultado->fecha_atencion }}</span>
                                    </td>
                                    <td>
                                        <span
                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $resultado->unidad_salud }}</span>
                                    </td>
                                    <td>
                                        <span
                                            class="text-dark-50 font-weight-bolder d-block font-size-lg">{{ $resultado->ingresa_por }}</span>
                                    </td>
                                    <td align="center">
                                        <i class="navi-item" data-toggle="modal" data-target="_self">
                                            <a href="{{ route('resultadomspindividual.show', $resultado->codigo) }}" class="navi-link">
...
{{--                                         <i class="navi-item">
                                            <a href="/informefinal/informemsp/{{ $resultado->codigo }}" target="_blank" class="navi-link">
                                            <span class="navi-icon">
