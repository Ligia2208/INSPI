<div class="col-xl-12">
            ...
            <div class="card-body pt-0 pb-3">
                ...
                <div class="table-responsive">
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @forelse ($Pacientes as $objPac)
                                <tr>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objPac->identidad }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objPac->apellidos }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objPac->nombres }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-25 font-weight-bolder d-block font-size-lg">{{ $objPac->fechanacimiento }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-25 font-weight-bolder d-block font-size-lg">{{ $objPac->direccion }}</span>
                                    </td>
                                    <td align="center">
                                        <i class="navi-item" data-toggle="modal" data-target="#edit-{{ $objPac->id }}">
                                        ...
                                        <i class="navi-item" onclick="event.preventDefault(); confirmDestroy({{ $objPac->id }})">
                                            <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                ...
                                @include('centrosreferencia.paciente.edit')
                            @empty
                                <!--begin::Col-->
                                <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <a href="{{ route('paciente.index') }}" class="btn btn-primary">Regresar</a>
    ...
    @include('centrosreferencia.paciente.create')
