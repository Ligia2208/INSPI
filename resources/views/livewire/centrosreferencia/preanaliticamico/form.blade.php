                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group input-group-solid">
                                        ...
                                        <input wire:model.defer="Preanaliticastoxico.nombre_lote" type="text"
                                            class="form-control form-control-solid @error('Preanaliticastoxico.nombre_lote') is-invalid @enderror"
                                            placeholder="Ej: Codigo del Lote" />
                                    </div>
                                    @error('Preanaliticastoxico.nombre_lote')
                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <div class="input-group input-group-solid">
                                        ...
                                        <select wire:model.defer="Preanaliticastoxico.n_tubos"
                                            class="form-control selectpicker form-control-solid @error('Preanaliticastoxico.n_tubos') is-invalid @enderror"
                                            data-size="7" data-live-search="true" data-show-subtext="true" required>
