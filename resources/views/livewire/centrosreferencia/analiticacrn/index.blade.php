                            ...
                            <div class="col-lg-12 col-xl-12">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2 my-2 my-md-0">
                                        <div class="d-flex align-items-center">
                                            <button class="btn btn-success font-weight-bold mr-2" onclick="exportToExcel('data', 'resultados-data')"><i class="fa fa-file-excel" aria-hidden="true"></i> {{__("Exportar a Excel")}}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card-body pt-0 pb-3">
                ...
                <div class="table-responsive">
                        <table id="data" class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                            ...
                            <tbody>
                                @forelse ($resultados as $analitica)
                                    <tr>
                                        <td>
                                            <span
                                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $analitica->anio_registro }} - {{ str_pad($analitica->codigo_muestra, 8, "0", STR_PAD_LEFT) }}</span>
                                        </td>
                                        <td>
                                            <span
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span
                                                class="text-dark-50 font-weight-bolder d-block font-size-lg">No aplica</span>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td align="center">
                                            <i class="navi-item" data-toggle="modal" data-target="_self">
                                                <a href="{{ route('analiticacrn.edit', $analitica) }}" class="navi-link">
