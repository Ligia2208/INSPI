                        ...
                        <div class="col-lg-12 col-xl-12">
                            <div class="row align-items-center">
                                <div class="col-md-12 my-2 my-md-0">
                                    <div id="chartdiv0"><h3>{{ $etiqueta0 }}</h3></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-5 ">
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-xl-12">
                            <div class="row align-items-center">
                                <div class="col-md-6 my-2 my-md-0">
                                    <div id="chartdiv7"><h3>{{ $etiqueta5 }}</h3></div>
                                </div>
                                <div class="col-md-6 my-2 my-md-0">
                                    <div id="chartdiv8"><h3>{{ $etiqueta6 }}</h3></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-5 ">
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-xl-12">
                            <div class="row align-items-center">
                                <div class="col-md-6 my-2 my-md-0">
                                    <div id="chartdiv9"><h3>{{ $etiqueta9 }}</h3></div>
                                </div>
                                <div class="col-md-6 my-2 my-md-0">
                                    <div id="chartdiv10"><h3>{{ $etiqueta10 }}</h3></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-5 ">
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-xl-12">
                            <div class="row align-items-center">
                                <div class="col-md-12 my-2 my-md-0">
                                    <div id="chartdiv3"><h3>{{ $etiqueta7 }}</h3></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-5 ">
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-xl-12">
                            <div class="row align-items-center">
                                <div class="col-md-12 my-2 my-md-0">
                                    <div id="chartdiv4"><h3>{{ $etiqueta8 }}</h3></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            $(function(){
                ...
                am5.ready(function() {
                    ...
                    var data = <?php print_r($data_insa);?> ;
                ...
                am5.ready(function() {
                    ...
                    series.data.setAll(<?php print_r($data_clase);?>);
                ...
                am5.ready(function() {
                    ...
                    var data = <?php print_r($data_tipo);?> ;
                    xAxis.data.setAll(data);
                    series.data.setAll(data);
                    series.appear(1000);
                    chart.appear(1000, 100);
                ...
                am5.ready(function() {
                    ...
                    series.data.setAll(<?php print_r($data_procesado);?>);
                ...
                am5.ready(function() {
                    ...
                    series.data.setAll(<?php print_r($data_cumple);?>);
                ...
                am5.ready(function() {
                    ...
                    series.data.setAll(<?php print_r($data_tecn);?>);
                ...
                am5.ready(function() {
                    ...
                    var data = <?php print_r($data_resu);?> ;
                    xAxis.data.setAll(data);
                    series.data.setAll(data);
                    series.appear(1000);
                    chart.appear(1000, 100);
