            ...
            <div class="card-body pt-0 pb-3">
                ...
                <div class="table-responsive">
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @forelse ($Vacunas as $objVacuna)
                                <tr>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objVacuna->fecha }} </span>
                                    </td>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objVacuna->nombre }} </span>
                                    </td>
                                    <td>
                                        <span class="text-dark-25 font-weight-bolder d-block font-size-lg">{{ $objVacuna->descripcion }}</span>
                                    </td>
                                    <td align="center">
                                        <i class="navi-item" data-toggle="modal" data-target="#edit-{{ $objVacuna->id }}">
                                        ...
                                        <i class="navi-item" onclick="event.preventDefault(); confirmDestroy({{ $objVacuna->id }})">
                                            <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                ...
                                @include('plataformas.vacuna.edit')
                            @empty 
                                <!--begin::Col-->
                                <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <a data-toggle="modal" data-target=".create" href="#" class="btn btn-primary">Agregar Vacuna</a>
                </div>
