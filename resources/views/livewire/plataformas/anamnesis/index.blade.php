        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <p class="text-gray-400 fs-4 fw-bold mb-10">Al parecer no tienes ninguna Manifestaciones Clínicas.
                    <br> Ponga en marcha CoreInspi añadiendo su primera Manifestación Clínica</p>
                    <a data-toggle="modal" data-target=".create" href="#" class="btn btn-primary">Agregar Manifestaciones Clínicas</a>
                </div>
