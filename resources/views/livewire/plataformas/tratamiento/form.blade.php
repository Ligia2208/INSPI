                        ...
                        <div class="my-5">
                            ...
                            <div class="form-group row" hidden>
                                <div class="col-12">
                                    ...
                                    <div class="input-group input-group-solid">
                                        ...
                                        <input 
                                            wire:model.defer="Tratamientos.especimen_id" 
                                            type="text" 
                                            required
                                            class="form-control @error('Tratamientos.especimen_id') is-invalid @enderror"  
                                            />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-4">
                                    <label>Fecha Aplicación<span class="text-danger">*</span></label>
                                        <div class="input-group input-group-solid">
                                            ...
                                            <input
                                                wire:model.defer="Tratamientos.fecha"
                                                value="Tratamientos.fecha"
                                                type="date" 
                                                class="start_date form-control form-control-solid @error('Tratamientos.fecha') is-invalid @enderror"  
                                                placeholder="Seleccione la fecha de compra del Artículo"
                                            />
                                        </div>
                                        @error('Tratamientos.fecha') 
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input 
                                    wire:model.defer="Tratamientos.descripcion" 
                                    type="text" 
                                    class="form-control form-control-solid @error('Tratamientos.descripcion') is-invalid @enderror"  
                                    placeholder="Ej: via subcutanea normal" /> 
                                </div>
                                @error('Tratamientos.descripcion') 
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
