                        ...
                        <div class="my-5">
                            ...
                            <div class="form-group row" hidden>
                                <div class="col-12">
                                    ...
                                    <div class="input-group input-group-solid">
                                        ...
                                        <input 
                                            wire:model.defer="Parasitos.especimen_id" 
                                            type="text" 
                                            required
                                            class="form-control @error('Parasitos.especimen_id') is-invalid @enderror"  
                                            />
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label>Fecha Aplicación<span class="text-danger">*</span></label>
                                        <div class="input-group input-group-solid">
                                            ...
                                            <input
                                                wire:model.defer="Parasitos.fecha"
                                                value="Parasitos.fecha"
                                                type="date" 
                                                class="start_date form-control form-control-solid @error('Parasitos.fecha') is-invalid @enderror"  
                                                placeholder="Seleccione la fecha de compra del Artículo"
                                            />
                                        </div>
                                        @error('Parasitos.fecha') 
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <div class="input-group-prepend">
                                        ...
                                        <input 
                                        wire:model.defer="Parasitos.nombre" 
                                        type="text" 
                                        class="form-control form-control-solid @error('Parasitos.nombre') is-invalid @enderror"  
                                        placeholder="Ej: Biolovac 8L" /> 
                                    </div>
                                    @error('Parasitos.nombre') 
                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                    @enderror
                                </div> 
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input 
                                    wire:model.defer="Parasitos.descripcion" 
                                    type="text" 
                                    class="form-control form-control-solid @error('Parasitos.descripcion') is-invalid @enderror"  
                                    placeholder="Ej: via subcutanea normal" /> 
                                </div>
                                @error('Parasitos.descripcion') 
                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
