...
@section("style")
    ...
    <script src="{{asset('assets/js/Inventario/create_egreso.js?v0.0.0')}}"></script>
	@endsection
...
<div class="page-wrapper">
	<div class="page-content mb-5">
        ...
        <h2 class="mb-0 text-uppercase text-center mt-5"><i class="font-32 text-success bi bi-clipboard2-pulse"></i> Registrar Corrida </h2>
            ...
            <div class="card-body">
                ...
                <div class="row p-2">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="hora" name="hora" class="form-control" required="" autofocus="" value="">
                        <div class="valid-feedback">Looks good!</div>
                    </div>
                ...
                <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="row">
                            ...
                            <div class="row" id="contenARN">
                                ...
                                <div class="col-md-4 mt-2">
                                    <input type="hidden" id="idInventReactARN0" name="idInventReactARN" class="form-control" required="" autofocus="" value="">
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <select id="loteARN0" name="loteARN" class="form-select single-select" required onchange="cargarUnidadesARN('loteARN0', 0)">
                                        <option value="0">Seleccione Lote</option>
                                    </select>
                                </div>

                                <div class="col-md-4 mt-2">
                                    <label for="fechaReactARN" class="form-label fs-6">Cantidad</label>
                                    <input type="text" id="cantReactARN0" name="cantReactARN" class="form-control" required="" autofocus="" value="1" disabled>
                                    <div class="valid-feedback">Looks good!</div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="list-termico" role="tabpanel" aria-labelledby="list-termico-list">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-2">
                                ...
                                <input type="text" id="canalesPer" name="canalesPer" class="form-control" required="" autofocus="" value="FAN (ZK, RNP)">
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="list-resultados" role="tabpanel" aria-labelledby="list-resultados-list">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-2">
                                <label for="fprocesaResult" class="form-label fs-6">Fecha de Procesamiento</label>
                                <input type="date" id="fprocesaResult" name="fprocesaResult" class="form-control" required="" autofocus="" value="">
                            </div>

                            <div class="col-md-4 mt-2">
                                <label for="freporteResult" class="form-label fs-6">Fecha de Reporte</label>
                                <input type="date" id="freporteResult" name="freporteResult" class="form-control" required="" autofocus="" value="">
                            </div>
                            ...
                            <table class="table table-striped table-hover mt-4">
                                ...
                                <tbody id="cuerpoTablaResultado">
                                    ...
                                    <tr id="">
                                        ...
                                        <td>
                                            <input type="text" id="fingresonRes" name="fingresonRes" class="form-control" placeholder="F. Ingreso" aria-label="F. Ingreso" aria-describedby="F. Ingreso" value="">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" id="muestraRes" name="muestraRes" class="form-control" placeholder="T. Muestra" aria-label="T. Muestra" aria-describedby="T. Muestra" value="">
                                            <input type="hidden" id="id_muestraRes" name="id_muestraRes" value="">
                                        </td>
                                        <td>
                        ...
                        <div id="bloqueImportForm" class="mt-2" style="display: none;">
                            <div class="d-flex justify-content-end align-items-center mb-2">
                                <a href="{{ asset('assets/doc/plantilla_resultados.csv') }}" download="plantilla_resultados.csv" class="btn btn-primary">
                                    Descargar Plantilla
                    ...
                    <div class="tab-pane fade" id="list-controles" role="tabpanel" aria-labelledby="list-controles-list">
                        ...
                        <!-- <div class="col-md-12 col-sm-12 col-12 mt-2">
                            <label for="recibe" class="form-label">Seleciones los Controles Usados</label>
                            <select class="js-example-basic-multiple form-select single-select" name="states[]" multiple="multiple" id="controlesSelect"
                                    data-width="100%" data-placeholder="Selecciona una opción" data-allow-clear="true">
                                    <option value="1"> CN Zika </option>
                                    <option value="2"> CN Chikungunya </option>
                                    <option value="3"> CN Mayaro </option>
                                    <option value="4"> CN Fiebre Amarilla </option>
                                    <option value="5"> CN RP </option>

                                    <option value="5"> CN extración Zika </option>
                                    <option value="5"> CN extración Chikungunya </option>
                                    <option value="5"> CN extración Mayaro </option>
                                    <option value="5"> CN extración Fiebre Amarilla </option>
                                    <option value="5"> CN extración RP </option>

                                    <option value="5"> CP Zika </option>
                                    <option value="5"> CP Chikungunya </option>
                                    <option value="5"> CP Mayaro </option>
                                    <option value="5"> CP Fiebre Amarilla </option>
                                    <option value="5"> CP RP </option>
                        ...
                        <table class="table table-striped table-hover mt-4">
                            ...
                            <tbody id="cuerpoTablaControles">
                                <tr id="">
                                    ...
                                    <td>
                                        <input type="text" id="ctControl0" name="ctControl" class="form-control" placeholder="Tiempo" value="30">
                                    </td>
                                    <td>
