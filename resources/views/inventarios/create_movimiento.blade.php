        ...
        <div class="page-content mb-5">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row p-2" id="cuerpoActa">
                        ...
                        <div class="col-md-3">
                            ...
                            <select id="tipo" name="tipo" class="form-control single-select" onchange="selectTipo()">
                        ...
                        <div class="col-md-4 mt-2">
                            ...
                            <input type="text" id="proveedor" name="proveedor" class="form-control" required="" autofocus="" value="">
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-4 col-sm-4 col-4 mt-2">
                            <label for="destino" class="form-label fs-6">Destino</label>
                            <select class="select2Core form-control" name="destino" id="destino">
                                <option value="0">Seleccione Laboratorio</option>
                                <option value="0">Seleccione 2</option>
                        ...
                        <div class="col-md-4 col-sm-4 col-4 mt-2">
                            ...
                            <select class="select2Core form-control" name="state" id="recibe"
                        ...
                        <div class="col-md-4 col-sm-4 col-4 mt-2">
                            ...
                            <input type="text" id="factura" name="factura" class="form-control" required="" autofocus="" value="">
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-4 col-sm-4 col-4 mt-2">
                            <label for="n_contrato" class="form-label fs-6">N° Orden de compra/Contrato/Catálogo electronico</label>
                            <input type="text" id="n_contrato" name="n_contrato" class="form-control" required="" autofocus="" value="">
                            <div class="valid-feedback">Looks good!</div>
                        </div>
                        ...
                        <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                            ...
                            <div class="row">
                                <div class="col-9">
                                    ...
                                    <a class="btn btn-light border encuesta d-flex align-items-center justify-content-center float-start me-2 mt-2" type="button" data-toggle="modal" data-target="#addCategoriaM">
                                        <i class="bi bi-app-indicator"></i> Agregar Categoría
                                    </a>

                                    <a class="btn btn-light border encuesta d-flex align-items-center justify-content-center float-start me-2 mt-2" type="button" data-toggle="modal" data-target="#addArticuloM">
...
<script src="{{asset('assets/js/Inventario/create_movimiento.js?v0.0.0')}}"></script>
