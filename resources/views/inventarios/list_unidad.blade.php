    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline mr-5">
                <a href="#"><h5 class="text-dark font-weight-bold my-2 mr-5">Unidad de Medidas</h5></a>
            </div>
        </div>
    </div>
</div>
...
<div id="kt_content" class="content d-flex flex-column flex-column-fluid">
    ...
    <div class="container2">
        <div class="page-content">
            ...
            <h2 class="mb-0 text-uppercase text-center mt-5"> <i class='font-32 text-success bx bx-table'></i> Unidades de Medidas </h2>
            <hr/>
            <a class="col-2 btn btn-primary px-1 d-flex align-items-center justify-content-center" data-toggle="modal" data-target="#addCategoria" type="button" id="btnModalOpen">
                <i class="lni lni-circle-plus"></i> Crear Unidad de medida
            </a>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tblIUnidadIndex" class="table table-striped table-bordered p-2">
                            <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <th>Abreviatura</th>
                                ...
                                <tr>
                                    ...
                                    <th><input type="text" placeholder="Buscar Abreviatura" /></th>
                                    <th><input type="text" placeholder="Buscar Estado" /></th>
                                    <th><input type="text" placeholder="Buscar Fecha" /></th>
                                    <th></th> <!-- Sin filtro en la columna de acciones -->
                                </tr>
                            </thead>
                            <tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="modalContent">
                        ...
                        <div class="col-md-12">
                            <label for="nameUnidad" class="form-label fs-6">Nombre de la Unidad de medida</label>
                            <input type="text" id="nameUnidad" name="nameUnidad" class="form-control" required="" autofocus="" value="">
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-12">
                            <label for="abreviaUnidad" class="form-label fs-6">Nombre de la abreviatura</label>
                            <input type="text" id="abreviaUnidad" name="abreviaUnidad" class="form-control" required="" autofocus="" value="">
                            <div class="valid-feedback">Looks good!</div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="btnUnidad">Guardar</button>
...
<script src="{{ asset('assets/js/Inventario/unidad.js?v0.0.0') }}"></script>
@endpush
