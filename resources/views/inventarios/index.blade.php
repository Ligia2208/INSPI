    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline mr-5">
                <a href="#"><h5 class="text-dark font-weight-bold my-2 mr-5">Inventario</h5></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container2">
        <div class="page-content mb-5">
            ...
            <div class="col">
                ...
                <div class="col">
                    <div class="card radius-10 border-start border-0 border-3 border-primary encuesta" onclick="redireccionEncuesta('ajuste')">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="my-1 text-primary ms-auto">Ajuste</h4>
                                </div>
            ...
            <h2 class="mb-0 text-uppercase text-center mt-5"> <i class='font-32 text-success bx bx-table'></i> Lista de Inventario </h2>
            <hr/>
            <div class="row">

                <!-- <a class="col-2 btn btn-primary px-1 d-flex align-items-center justify-content-center me-2" href="{{ route('inventario.crearMovimiento') }}" type="button" >
                ...
                <a class="col-2 btn btn-primary px-1 d-flex align-items-center justify-content-center" data-toggle="modal" data-target="#addReportInventarioGeneral" type="button" id="btnModalOpen">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tblInventarioIndex" class="table table-striped table-bordered" style="width:100%">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Articulo</th>
...
<a id="btnModalReport" data-toggle="modal" data-target="#addReportInventario" class="d-none"></a>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Generar Registro de Control de Inventario</h5>
            ...
            <div class="modal-body">
                ...
                <div id="modalContent">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" id="id_inventario" name="id_inventario" class="form-control" required="" autofocus="" value="">
...
<div class="modal fade" id="addReportInventarioGeneral" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<script src="{{asset('assets/js/Inventario/initInventario.js?v0.0.3')}}"></script>
@endpush