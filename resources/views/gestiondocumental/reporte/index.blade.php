...
@section('title', 'Reportes Gestor Documental')
...
@section('content')
    ...
    <script>
        ...
        var options = {
            ...
            display: true,
            position: "top",
            text: "Solicitudes asignadas hoy",
            fontSize: 18,
            fontColor: "#111"
            },
            scales: {
    ...
    <script>
        ...
        var options = {
            ...
            display: true,
            position: "top",
            text: "Origen Solicitudes últimos 7 días",
            fontSize: 18,
            fontColor: "#111"
            },
            legend: {
    ...
    <script>
        ...
        var options = {
            ...
            display: true,
            position: "top",
            text: "Solicitudes asignadas últimos 7 días",
            fontSize: 18,
            fontColor: "#111"
            },
            scales: {
    ...
    <script>
        ...
        var options = {
            ...
            display: true,
            position: "top",
            text: "Origen Solicitudes últimos 30 días",
            fontSize: 18,
            fontColor: "#111"
            },
            legend: {
    ...
    <script>
        ...
        var options = {
            ...
            display: true,
            position: "top",
            text: "Solicitudes asignadas últimos 30 días",
            fontSize: 18,
            fontColor: "#111"
            },
            scales: {
    ...
    <script>
        ...
        var options = {
            ...
            display: true,
            position: "top",
            text: "Solicitudes asignadas por fecha últimos 30 días",
            fontSize: 18,
            fontColor: "#111"
            },
            scales: {
