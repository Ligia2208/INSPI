...
@section('title', $solicitudenv->numerodocumento)
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline mr-5">
                    <a class="text-dark" href="{{ route('solicitudenv.index') }}"><h5 class="text-dark font-weight-bold my-2 mr-5">Solicitudes</h5></a>
                        ...
                        <div class="card card-custom mb-5 ">
                            ...
                            <div class="card-body py-4">
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-8">
                                        <span class="form-control-plaintext font-weight-bolder">{{ $solicitudenv->origen->nombre }}</span>
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                                    <label class="col-4 col-form-label">Dependencia:</label>
                                    <div class="col-8">
                                        <span class="form-control-plaintext font-weight-bolder">{{ $solicitudenv->dependencia->nombre }}</span>
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-8">
                                        <span class="form-control-plaintext">
                                            <span class="font-weight-bolder">{{ $solicitudenv->numerodocumento }}</span>
                                        </span>
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-8">
                                        <span class="form-control-plaintext font-weight-bolder">{{ $solicitudenv->fechadocumento }}</span>
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                                ...
                                <div class="">
                                    <p class="text-dark-75 font-weight-bolder font-size-h5 m-0">
                                        @if ($solicitudenv->destino_id>0)
                                            <span class="badge badge-info">{{ $destino->nombre }}</span>
                                        @else
                                            <span class="badge badge-secondary">Ningun área ha sido asignada"</span>
                                        @endif
                                    </p> 
                                    <br>
                                    <div class="font-weight-bold text-success mb-5">Sumillado: {{ $solicitudenv->sumillado }}</div>
                                </div>                       
                            </div>
                            <!--end::Body-->
                        </div>
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header h-auto py-4">
                                <div class="card-title">
                                    <h3 class="card-label">{{ $solicitudenv->numerodocumento }}</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                @if ($solicitudenv->archivo)
                                    <embed width="100%" height="600px" src="{{ Storage::url($solicitudenv->archivo) }}" type="">
                                @else
