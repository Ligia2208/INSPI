...
@section('title', $historico->numerodocumento)
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline mr-5">
                    <a class="text-dark" href="{{ route('historico.index') }}"><h5 class="text-dark font-weight-bold my-2 mr-5">Solicitudes</h5></a>
                    ...
                    <div class="col-xl-4">
                            ...
                            <div class="card-header h-auto py-4">
                                ...
                                <div class="d-flex justify-content-end">
                                    <i class="navi-item" data-toggle="modal" data-target="_self">
                                        <a href="{{ route('historico.index') }}" class="navi-link">
                                ...
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-8">
                                        <span class="form-control-plaintext">
                                            <span class="font-weight-bolder">{{ $historico->numerodocumento }}</span>
                                        </span>
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                                    ...
                                    <div class="col-8">
                                        <span class="form-control-plaintext font-weight-bolder">{{ $historico->fechadocumento }}</span>
                                    </div>
                                </div>
                                <div class="form-group row my-2">
                            ...
                            <div class="card-body">
                                <div class="">
                                    <p class="text-dark-75 font-weight-bolder font-size-h5 m-0">
                                        @if ($historico->area_id>0)
                                            <span class="badge badge-info">Asignado a: {{ $historico->area->nombre }} el {{ $historico->fechaasignacionde}}</span>
                                        @else
                                            <span class="badge badge-secondary">Ningun área ha sido asignada"</span>
                                        @endif
                                    </p> 
                                    <br>
                                    <div class="font-weight-bold text-success mb-5">Sumillado Dirección Ejecutiva: {{ $historico->sumillado }}</div>
                                </div>                       
                            </div>
                            <!--end::Body-->
                        </div>
                        <div class="card bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url({{ asset('assets') }}/media/svg/shapes/abstract-4.svg)">
                            ...
                            <div class="card-body">
                                <div class="">
                                    <p class="text-dark-75 font-weight-bolder font-size-h5 m-0">
                                        <span class="badge badge-info">Fecha Respuesta: {{ $historico->fechaasignaciondg }}</span>
                                    </p> 
                                    <br>
                                    <div class="font-weight-bold text-success mb-5">Actividades realizadas: {{ $historico->sumillado_dirgen }}</div>
                                </div>                       
                            </div>
                            <!--end::Body-->
                        </div>
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-header h-auto py-4">
                                <div class="card-title">
                                    <h3 class="card-label">{{ $historico->numerodocumento }}</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                @if ($historico->archivo)
                                    <embed width="100%" height="600px" src="{{ Storage::url($historico->archivo) }}" type="">
                                @else
