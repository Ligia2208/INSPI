...
<head>
    ...
    <title>Nuevo usuario CoreInspi</title>
    <style type="text/css">
        body {
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td valign="top" align="center" class="specbundle">
                                                                                                        <div class="contentEditableContainer contentTextEditable">
                                                                                                            <div class="contentEditable">
                                                                                                                <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;'><span class="specbundle2"><span class="font1">&nbsp;</span></span>
                                                                                                                </p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </td>
                                                                                                    <td valign="top" class="specbundle">
                                                                                                        <div class="contentEditableContainer contentTextEditable">
                                                                                                            <div class="contentEditable">
                                                                                                                <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#1A54BA;'><span class="font">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                                                            ...
                                                                            <tr>
                                                                                <td align='left'>
                                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                                        <div class="contentEditable" align='center'>
                                                                                            <p>Hola {{ $user->name }}, utiliza este correo y tu contraseña {{ $password }} para iniciar sesión en el <a href="{{ config('app.url') }}" target="_blank" rel="noopener noreferrer">Sistema Integrado del Instituto Nacional de Investigación en Salud Pública - INSPI</a> </p>
                                                                                                        ...
                                                                                                        <div class="contentEditableContainer contentTextEditable">
                                                                                                            <div class="contentEditable" align='center'>
                                                                                                                <p style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                                                                                                    <span style='font-weight:bold;'>CoreInspi - Desarrollado por Gestión de Tecnologías de la Información y Comunicación</span>
                                                                                                                </p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </td>
