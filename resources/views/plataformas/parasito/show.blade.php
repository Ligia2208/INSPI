        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header" wire:ignore>
                ...
                <div class="card-toolbar">
                    ...
                    &nbsp;&nbsp;
                    <a href="/parasitos/agregar/{{ $objEsp->id }}" class="btn btn-primary btn-shadow font-weight-bold mr-2 "><i class="fa fa-sticky-note"></i>Agregar Desparasitación</a>
                </div>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <p class="text-gray-400 fs-4 fw-bold mb-10">Al parecer no tienes ninguna Desparasitación.
                    <br> Ponga en marcha CoreInspi añadiendo su primera Desparasitación</p>
                    <a href="/parasitos/agregar/{{ $objEsp->id }}" class="btn btn-primary btn-shadow font-weight-bold mr-2 "><i class="fa fa-sticky-note"></i>Agregar Desparasitación</a>
                </div>
