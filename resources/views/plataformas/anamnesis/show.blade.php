...
<div class="container">
        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header" wire:ignore>
                ...
                <div class="card-toolbar">
                    ...
                    &nbsp;&nbsp;
                    <a href="/vacunas/agregar/{{ $objEsp->id }}" class="btn btn-primary btn-shadow font-weight-bold mr-2 "><i class="fa fa-sticky-note"></i>Agregar Anamnesiss</a>
                </div>
            </div>
            <!--end::Header-->
            <!--begin::Body-->
            <div class="card-body pt-0 pb-3">
                ...
                <div class="table-responsive">
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        ...
                        <tbody>
                            @forelse ($Anamnesiss as $objAnamnesis)
                                <tr>
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $objAnamnesis->fecha }} </span>
                                    </td>
                                    <td>
                                        <span class="text-dark-25 font-weight-bolder d-block font-size-lg">{{ $objAnamnesis->descripcion }}</span>
                                    </td>
                                    <td align="center">
                                        <i class="navi-item" data-toggle="modal" data-target="#edit-{{ $objAnamnesis->id }}">
                                        ...
                                        <i class="navi-item" onclick="event.preventDefault(); confirmDestroy({{ $objAnamnesis->id }})">
                                            <a href="#" class="navi-link">
                                            <span class="navi-icon">
                                ...
                                @include('plataformas.anamnesis.edit')
                            @empty 
                                <!--begin::Col-->
                                <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-px text-center py-5">
                    ...
                    <p class="text-gray-400 fs-4 fw-bold mb-10">Al parecer no tienes ninguna Anamnesis.
                    <br> Ponga en marcha CoreInspi añadiendo su primera Anamnesiss</p>
                    <a href="/anamnesiss/agregar/{{ $objEsp->id }}" class="btn btn-primary btn-shadow font-weight-bold mr-2 "><i class="fa fa-sticky-note"></i>Agregar Anamnesis</a>
                </div>
    ...
    @endif
    @include('plataformas.anamnesis.create')
</div>
@endsection
