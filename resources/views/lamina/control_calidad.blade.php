            ...
            <div class="card">
                        ...
                        <div class="row p-2">
                            ...
                            <div class="row col-lg-12">
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <input type="number" id="total_laminas_pos" name="total_laminas_pos" class="form-control total-lamina" value="" required >
                                    <div class="valid-feedback">Looks good!</div>
                                </div>

                                <div class="col-md-4 mt-2">
                                    <label for="porcentaje_laminas_pos" class="form-label fs-6">Porcentaje Positivas</label>
                                    <input type="number" id="porcentaje_laminas_pos" name="porcentaje_laminas_pos" class="form-control total-lamina" value="" required >
                                    <div class="valid-feedback">Looks good!</div>
                                </div>
                            ...
                            <div class="row col-lg-12">
                                ...
                                <div class="col-md-4 mt-2">
                                    ...
                                    <input type="number" id="total_laminas_neg" name="total_laminas_neg" class="form-control total-lamina" value="" required >
                                    <div class="valid-feedback">Looks good!</div>
                                </div>

                                <div class="col-md-4 mt-2">
                                    <label for="porcentaje_laminas_neg" class="form-label fs-6">Porcentaje Negativas</label>
                                    <input type="number" id="porcentaje_laminas_neg" name="porcentaje_laminas_neg" class="form-control total-lamina" value="" required >
                                    <div class="valid-feedback">Looks good!</div>
                                </div>
                            ...
                            <div class="col-md-4 mt-2">
                                <label for="total_laminas_califica" class="form-label fs-6">Calificación</label>
                                <input type="number" id="total_laminas_califica" name="total_laminas_califica" class="form-control total-lamina" value="" required disabled>
                                <div class="valid-feedback">Looks good!</div>
                            </div>

                            <div class="col-md-12 mt-2">
                                <label for="recomendacion" class="form-label fs-6">Recomendación</label>
                                <textarea id="recomendacion" name="recomendacion" class="form-control" rows="3" required></textarea>
                            </div>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="mt-5">Datos de Tinción</h3>
                        <table class="table table-bordered">
                            <thead class="table-dark">
                                <tr>
                        ...
                        <h3 class="mt-5">Datos de Apariencia</h3>
                        <table class="table table-bordered">
                            <thead class="table-dark">
                                <tr>
...
<script src="{{asset('assets/js/Lamina/control_calidad.js?v0.0.0')}}"></script>
@endpush
