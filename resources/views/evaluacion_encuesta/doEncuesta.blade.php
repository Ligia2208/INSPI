...
<div class="page-wrapper">
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="container mt-4">
                                                    <section class="row">
                                                        ...
                                                        <!-- <div class="col-md-6 mt-2">
                                                            <label for="servicioName" class="form-label">Nombre del servicio</label>
                                                            <input type="text" id="servicioName" name="servicioName" class="form-control @error('servicioName') is-invalid @enderror" required="" autofocus="" placeholder="Ingrese el nombre del servicio">
                                                            <div class="valid-feedback">Looks good!</div>
                                                            @error('servicioName')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
 ...
 -->
                                                ...
                                                <section class="row mt-5">
                                                <div class="col-md-12">
                                                    <button type="button" class="btn btn-info" id="saveForm" onclick="guardar()">Guardar Encuesta</button>
