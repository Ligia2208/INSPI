    ...
    <div class="container2">
        <div class="page-content mb-5">
            ...
            <div class="col-lg-12 d-flex align-items-center justify-content-center">
                <a class="col-2 btn btn-primary px-1 mb-5" type="button" onclick="agregarComentarioEstado()" style="margin-right: 2%">
                    <i class="bi bi-send-check"></i> Enviar revisión
                </a>

                <a class="col-2 btn btn-danger px-1 p mb-5" type="button" onclick="window.location.href='/planificacion'">
