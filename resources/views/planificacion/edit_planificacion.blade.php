                ...
                <div class="card-body">
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-md-4 mt-2">
                            ...
                            <input type="text" id="monto" name="monto" class="form-control" required="" autofocus="" value="{{$atributos->monto}}">
...
<script src="{{asset('assets/js/Planificacion/editPlanificacion.js?v0.0.22')}}"></script>
@endpush