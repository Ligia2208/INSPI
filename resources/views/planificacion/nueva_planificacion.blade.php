    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        <div class="d-flex align-items-center flex-wrap mr-1">
            <div class="d-flex align-items-baseline mr-5">
                <a href="#"><h5 class="text-dark font-weight-bold my-2 mr-5">Crear Planificación con Monto 0</h5></a>
            </div>
        </div>
    </div>
</div>
...
<div id="kt_content" class="content d-flex flex-column flex-column-fluid">
    ...
    <div class="container2">
        <div class="page-content mb-5">
            <h2 class="mb-0 text-uppercase text-center mt-5"><i class="font-32 text-success bi bi-window-plus titulo-grande"></i> Creación de Sub Actividad/Objeto de Contratación con Monto 0 </h2>

            <div class="d-flex align-items-center p-3 text-white bg-info rounded shadow-sm mt-5">
                <div class="lh-1">
                    <h1 class="h3 mb-0 text-white lh-1"><i class="bi bi-info-circle-fill mr-2"></i>Nota</h1>
                    <hr>
                    <h6>Esta Subactividad/Objeto de Contratación se creará con un monto de 0. Una vez creada, podrá asignarle valores en la solicitud de reforma.</h6>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row p-2">
                            ...
                            <div class="col-md-4 mt-2">
                                ...
                                <input type="number" id="monto" name="monto" class="form-control" required="" autofocus="" value="0" onchange="" disabled>
                ...
                <div class="card-body">
                    <div class="row p-2">
                        ...
                        <div class="col-md-4 mt-2">
                            ...
                            <select id="programa" name="programa" class="form-control single-select" required="" {{ $id_direccion == 18 ? '' : 'disabled' }} ></select>
                        </div>

                        <div class="col-md-4 mt-2">
                            <label for="proyecto" class="form-label fs-6">Proyecto</label>
                            <select id="proyecto" name="proyecto" class="form-control single-select" required="" {{ $id_direccion == 18 ? '' : 'disabled' }}></select>
                        </div>


                        <div class="col-md-6 mt-2">
                            <label for="actividad" class="form-label fs-6">Actividad</label>
                            <select id="actividad" name="actividad" class="form-control single-select" required="" {{ $id_direccion == 18 ? '' : 'disabled' }}></select>
                        </div>

                        <div class="col-md-6 mt-2">
                            <label for="fuente_financiamiento" class="form-label fs-6">Fuente de financiamiento</label>
                            <select id="fuente_financiamiento" name="fuente_financiamiento" class="form-control single-select" required="" {{ $id_direccion == 18 ? '' : 'disabled' }}></select>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row p-2">
                        <div class="col-md-4 mt-2">
                            ...
                            <select id="frecuencia" name="frecuencia" class="form-select single-select" required disabled>
                                ...
                                <option value="8" selected> En 0 </option>
                    ...
                    <div class="row p-2 mt-1">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" id="enero" name="enero" class="form-control" required="" autofocus="" value="0.00" disabled>
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-3">
                            <label for="febre" class="form-label fs-6">Febrero</label>
                            <input type="text" id="febre" name="febre" class="form-control" required="" autofocus="" value="0.00" disabled>
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-3">
                            <label for="marzo" class="form-label fs-6">Marzo</label>
                            <input type="text" id="marzo" name="marzo" class="form-control" required="" autofocus="" value="0.00" disabled>
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-3">
                            <label for="abril" class="form-label fs-6">Abril</label>
                            <input type="text" id="abril" name="abril" class="form-control" required="" autofocus="" value="0.00" disabled>
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-3 mt-2">
                            <label for="mayo" class="form-label fs-6">Mayo</label>
                            <input type="text" id="mayo" name="mayo" class="form-control" required="" autofocus="" value="0.00" disabled>
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-3 mt-2">
                            <label for="junio" class="form-label fs-6">Junio</label>
                            <input type="text" id="junio" name="junio" class="form-control" required="" autofocus="" value="0.00" disabled>
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-3 mt-2">
                            <label for="julio" class="form-label fs-6">Julio</label>
                            <input type="text" id="julio" name="julio" class="form-control" required="" autofocus="" value="0.00" disabled>
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-3 mt-2">
                            <label for="agosto" class="form-label fs-6">Agosto</label>
                            <input type="text" id="agosto" name="agosto" class="form-control" required="" autofocus="" value="0.00" disabled>
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-3 mt-2">
                            <label for="septiem" class="form-label fs-6">Septiembre</label>
                            <input type="text" id="septiem" name="septiem" class="form-control" required="" autofocus="" value="0.00" disabled>
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-3 mt-2">
                            <label for="octubre" class="form-label fs-6">Octubre</label>
                            <input type="text" id="octubre" name="octubre" class="form-control" required="" autofocus="" value="0.00" disabled>
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-3 mt-2">
                            <label for="noviem" class="form-label fs-6">Noviembre</label>
                            <input type="text" id="noviem" name="noviem" class="form-control" required="" autofocus="" value="0.00" disabled>
                            <div class="valid-feedback">Looks good!</div>
                        </div>

                        <div class="col-md-3 mt-2">
                            <label for="diciem" class="form-label fs-6">Diciembre</label>
                            <input type="text" id="diciem" name="diciem" class="form-control" required="" autofocus="" value="0.00" disabled>
                            <div class="valid-feedback">Looks good!</div>
                        </div>
