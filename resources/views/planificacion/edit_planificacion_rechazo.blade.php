                ...
                <div class="card-body">
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-md-12">
                            ...
                            <select id="obOpera" name="item_presupuestario" class="form-control single-select" required disabled>
                        ...
                        <div class="col-md-4 mt-2">
                            ...
                            <input type="text" id="monto" name="monto" class="form-control" required="" autofocus="" value="{{$atributos->monto}}" disabled>
...
<script src="{{asset('assets/js/Planificacion/editPlanificacionRechazado.js?v0.0.0')}}"></script>
@endpush