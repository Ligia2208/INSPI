    ...
    */
    ...
    document.getElementById('importButton').addEventListener('click', function() {
        ...
        if(nombre == ''){
            ...
            formData.append('n_contrato', n_contrato); 
...
function agregarMovimiento(){
    ...
    $('#cuerpoTablaMovimiento').append(
        ...
        <tr id="trDeleteMov${contMovimiento}">
            ...
            <td>
                <select id="nameArticulo${contMovimiento}" name="nameArticulo" class="form-control js-example-basic-single">

                </select>
            </td>

            <td>
                <select id="cantidad${contMovimiento}" name="cantidad" class="form-control js-example-basic-single">
            ...
            <td><input type="text" id="lote" name="lote" class="form-control" required="" autofocus="" value=""></td>
            <td>
...
function cargarMarca(id){
    ...
    $.ajax({
        ...
        error: function(error) {
            console.error('Error al obtener la lista de las Marcas:', error);
        }
    ...
    $('tbody#cuerpoTablaEgreso tr').each(function(index, row) {
        ...
        if (resultadoResta < 0) {
            ...
            Swal.fire({
                ...
                type: 'warning',
                title: 'SoftInspi',
                text: 'La resta de unidades en stock y unidades a transferir es negativa en la fila ' + (index + 1),
                showConfirmButton: true,
            });
