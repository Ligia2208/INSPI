$( function () {
    ...
    $(document).on('click', '#btnGuardarSolicitud', function() {
        ...
        if (centroSalud == 0) {
            ...
            Swal.fire({ icon: 'warning', title: 'SoftInspi', text: 'Debe de ingresar el nomnbre del director de la U.S.', showConfirmButton: true });
            return;
            ...
            return;
        } else if (total_laminas_super == 0 || total_laminas_super == '') {
            Swal.fire({ icon: 'warning', title: 'SoftInspi', text: 'Debe ingresar un número de Láminas Enviadas.', showConfirmButton: true });
            return;
        }
